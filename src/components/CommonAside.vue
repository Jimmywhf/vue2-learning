<template>
    ...
    <el-submenu v-for="item in hasChildren" :index="item.path" :key="item.path">
        ...
        <el-menu-item-gouup v-for="(subItem, subIndex) in item.children" :key="subItem.path">
            <el-menu-item @click="clickMenu(subItem)" :index="subIndex"><i :class="'el-icon-' + subItem.icon"></i>{{subItem.label }}</el-menu-item>
        </el-menu-item-gouup>
